...
import { TimetableSection } from "@/components/services/timetable-section"
import { BusStopsSection } from "@/components/services/bus-stops-section"
import { FAQSection } from "@/components/services/faq-section"

export const metadata: Metadata = {
  title: "Narita & Haneda Airport Shuttle | Myoko Shuttle",
  description: "Direct shuttle services between Tokyo airports and Myoko area ski resorts with luggage-friendly transport and multiple daily departures.",
}

export default function NaritaHanedaPage() {
  const serviceFeatures = [
    { icon: Clock, text: "Multiple Daily Services" },
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative bg-slate-50 py-12 md:py-20 overflow-hidden">
        {/* Decorative elements */}
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 leading-[1.15]">
                  Narita & Haneda <span className="text-primary">Airport Transfers</span> to Myoko
                </h1>
                <p className="text-lg text-slate-600 max-w-2xl leading-relaxed">
                  Direct shuttle services between Tokyo airports and Myoko area ski resorts with luggage-friendly transport and multiple daily departures.
                </p>
              </div>
