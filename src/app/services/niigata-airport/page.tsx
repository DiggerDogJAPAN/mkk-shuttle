...
import { NiigataTimetable } from "@/components/services/niigata-timetable"
import { NiigataBusStops } from "@/components/services/niigata-bus-stops"

export const metadata: Metadata = {
  title: "Niigata Airport Transfers | Myoko Shuttle",
  description: "Direct winter shuttle services between Niigata Airport, Myoko, Madarao, and nearby ski resorts with luggage-friendly transport.",
}

export default function NiigataAirportPage() {
  const serviceFeatures = [
    { icon: Plane, text: "Direct Airport Service" },
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 leading-[1.15]">
                  Niigata Airport Transfers <span className="text-primary">to Myoko & Lotte Arai</span>
                </h1>
                <p className="text-lg text-slate-600 max-w-2xl leading-relaxed">
                  Direct winter shuttle services between Niigata Airport, Myoko and Lotte Arai with luggage-friendly transport and resort drop-offs.
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white shadow-sm border border-slate-100 group transition-all hover:border-primary/30 hover:shadow-md">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-500 uppercase tracking-tight">Niigata Airport</p>
                    <p className="text-xl font-bold text-slate-900">From <span className="text-primary">¥4,500</span></p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white shadow-sm border border-slate-100 group transition-all hover:border-primary/30 hover:shadow-md">
                  ...
                  <div>
                    <p className="text-xs font-medium text-slate-500 uppercase tracking-tight">Myoko Area</p>
                    <p className="text-xl font-bold text-slate-900">From <span className="text-primary">¥4,500</span></p>
                  </div>
                </div>
              </div>
