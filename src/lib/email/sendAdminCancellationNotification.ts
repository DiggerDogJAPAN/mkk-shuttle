...
export const sendAdminCancellationNotification = async (booking: any) => {
  ...
  await resend.emails.send({
    ...
    subject: 'Booking Cancelled – MKK Shuttle',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="UTF-8" />
        <title>Booking Cancelled – MKK Shuttle</title>
      </head>
          ...
          <tr>
            <td align="center">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; background:#ffffff; border-radius:8px; overflow:hidden; border:1px solid #DDDDDD;">
                ...
                <tr>
                  <td style="background:#8b0000; padding:20px; text-align:left;">
                ...
                <tr>
                  <td style="padding:30px 20px;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse; margin:0 0 20px;">
                      <tr>
                        <td style="padding:10px; border:1px solid #EEEEEE; background:#FAFAFA; font-weight:bold; width:35%;">Final Status</td>
                        <td style="padding:10px; border:1px solid #EEEEEE; font-weight:bold; color:#8b0000; text-transform:uppercase;">${booking.status}</td>
                      </tr>
                      <tr>
                        <td style="padding:10px; border:1px solid #EEEEEE; background:#FAFAFA; font-weight:bold;">Reference</td>
                      ...
                      <tr>
                        <td style="padding:10px; border:1px solid #EEEEEE; background:#FAFAFA; font-weight:bold;">Cancellation Reason</td>
                        <td style="padding:10px; border:1px solid #EEEEEE;">${booking.cancellation_reason || 'N/A'}</td>
                      </tr>
                      <tr>
                        <td style="padding:10px; border:1px solid #EEEEEE; background:#FAFAFA; font-weight:bold;">Cancellation Fee</td>
                        <td style="padding:10px; border:1px solid #EEEEEE; font-weight:bold; color:#8b0000;">¥${Number(booking.cancellation_fee || 0).toLocaleString()}</td>
                      </tr>
                      <tr>
                        <td style="padding:10px; border:1px solid #EEEEEE; background:#FAFAFA; font-weight:bold;">Refund Amount</td>
                        <td style="padding:10px; border:1px solid #EEEEEE; font-weight:bold; color:#006600;">¥${Number(booking.refund_amount || 0).toLocaleString()}</td>
                      </tr>
                    </table>
